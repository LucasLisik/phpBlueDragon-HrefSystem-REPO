...
// GitHubProjects/phpBlueDragonHrefSystem/
...
$SqlQuert[] = "CREATE TABLE IF NOT EXISTS [DBPREFIX]archive (
  archive_id int(11) NOT NULL AUTO_INCREMENT,
  archive_project_id int(11) NOT NULL,
...
(5, 'foot', 'Copyright &copy; <a href=\"http://phpbluedragon.eu\">phpBlueDragon HrefSystem</a>'),
(6, 'column', 'project_id'),
(7, 'order', 'asc'),
...
$SqlQuert[] = "CREATE TABLE IF NOT EXISTS [DBPREFIX]project_archive (
  link_id int(11) NOT NULL AUTO_INCREMENT,
  link_link_id int(11) NOT NULL,
  link_project_id int(11) NOT NULL,
  link_url varchar(255) NOT NULL,
  link_text varchar(255) NOT NULL,
  link_exists char(1) NOT NULL,
  link_robots varchar(255) NOT NULL,
  link_nofollow char(1) NOT NULL,
  link_meta varchar(255) NOT NULL,
  link_http varchar(10) NOT NULL,
  link_howmany int(11) NOT NULL,
  link_date date NOT NULL,
  link_archive_id int(11) NOT NULL,
  PRIMARY KEY (link_id),
  KEY link_project_id (link_project_id)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;";

$SqlQuert[] = "CREATE TABLE IF NOT EXISTS [DBPREFIX]project_link (
  link_id int(11) NOT NULL AUTO_INCREMENT,
  link_project_id int(11) NOT NULL,
  link_url varchar(255) NOT NULL,
  link_text varchar(255) NOT NULL,
  ...
  link_http varchar(10) NOT NULL,
  link_howmany int(11) NOT NULL,
  link_check char(1) NOT NULL,
  link_checkhand char(1) NOT NULL,
  PRIMARY KEY (link_id),
  KEY link_project_id (link_project_id)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;";
...
// Relacja link
$SqlQuert[] = "ALTER TABLE [DBPREFIX]project_link
  ADD CONSTRAINT [DBPREFIX]project_link_ibfk_1 FOREIGN KEY (link_project_id) REFERENCES [DBPREFIX]project (project_id) ON DELETE CASCADE ON UPDATE NO ACTION;";
  
// Relacja ProjectArchive
$SqlQuert[] = "
ALTER TABLE [DBPREFIX]project_archive
  ADD CONSTRAINT [DBPREFIX]project_archive_ibfk_1 FOREIGN KEY (link_project_id) REFERENCES [DBPREFIX]project (project_id) ON DELETE CASCADE ON UPDATE NO ACTION;";

// Relacja Archive
$SqlQuert[] = "
ALTER TABLE [DBPREFIX]archive
  ADD CONSTRAINT [DBPREFIX]archive_ibfk_1 FOREIGN KEY (archive_project_id) REFERENCES [DBPREFIX]project (project_id) ON DELETE CASCADE ON UPDATE NO ACTION;";
...
function GetLang($Line)
{
    if($_SESSION['language_install'] == 'polish')
    {
    	...
    	$lang['install_subbar'] = 'Instalator programu phpBlueDragon HrefSystem';
    ...
    else
    {
        ...
        $lang['install_subbar'] = 'Setup phpBlueDragon HrefSystem'; 
