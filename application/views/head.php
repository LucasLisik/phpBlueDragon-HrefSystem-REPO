...
<div class="container" style="margin-top: 5px;">
    <div class="header" style="padding-top: 7px;">
        <div style="float: left;"><a href="<?php echo $UrlOfPage; ?>" title="phpBlueDragon HrefSystem"><img src="<?php echo $UrlOfPage; ?>hrefsystem.png" width="35" height="35" /></a></div>
        <div style="float: left;">&nbsp;&nbsp;</div>
        <div style="float: left; margin-top: 4px;"><a href="<?php echo $UrlOfPage; ?>" style="font-weight: normal; font-size: 20px; text-decoration: none; color: #1c87a8;">PBD HrefSystem</a></div>
    </div>
    <div class="menu">
        <div id="cssmenu">
        <ul>
            ...
            if($_SESSION['user_id'] != "")
            {
                ...
                <li <?php echo $ImportSelect; ?>><a href="<?php echo $UrlOfPage; ?>import/"><?php echo $this->lang->line('a0939'); ?></a></li>
