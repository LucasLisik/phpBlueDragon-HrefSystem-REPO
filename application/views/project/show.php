...
echo '<div class="row RowColor3">
  ...
  <div class="col-md-3">'.$this->lang->line('a1040').' <a href="'.base_url('?column=project_name&order=asc').'" '.$LinkNameASC.'>&uarr;</a> <a href="'.base_url('?column=project_name&order=desc').'" '.$LinkNameDESC.'>&darr;</a></div>
  <div class="col-md-2">'.$this->lang->line('a1041').' <a href="'.base_url('?column=project_href&order=asc').'" '.$LinkHrefASC.'>&uarr;</a> <a href="'.base_url('?column=project_href&order=desc').'" '.$LinkHrefDESC.'>&darr;</a></div>
  ...
  <div class="col-md-2" style="text-align: center;">'.$this->lang->line('a1043').' <a href="'.base_url('?column=project_long&order=asc').'" '.$LinkLongASC.'>&uarr;</a> <a href="'.base_url('?column=project_long&order=desc').'" '.$LinkLongDESC.'>&darr;</a></div>
...
foreach($ResultDB->result() as $row)
{
    ...
    <div class="col-md-3"><a href="'.base_url('details/'.$row->project_id).'">'.$row->project_name.'</a></div>
    <div class="col-md-2">'.$row->project_href.'</div>
    <div class="col-md-2" style="text-align: center;">'.$row->project_lastcheck.'</div>
    <div class="col-md-2" style="text-align: center;">'.$row->project_long.'</div>
