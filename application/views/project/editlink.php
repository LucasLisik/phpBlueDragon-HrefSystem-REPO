...
<li class="active">'.$this->lang->line('a1003').'</li>
</ol>';
...
if($IsAdded)
{
    echo '<div class="alert alert-success">'.$this->lang->line('a1004').'</div>';
}

echo form_open('link-edit/'.$LinkId);
...
echo form_hidden('link_id', $LinkId);
echo form_hidden('formlogin','yes');
echo form_submit(array('name' => 'buttonstart', 'value' => ''.$this->lang->line('a1005').'', 'class' => 'btn btn-info btn-block'));
echo form_close();
